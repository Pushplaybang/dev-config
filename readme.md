...
* sublime text
* iterm2 (with yaddir, zsh, and solarized theme)
* Robomongo
* Sequel Pro
* Tower 2
...
* Docker Toolbox
* virtualbox (will be installed with docker Toolbox)
* vagrant
* Homestead
...
xcode is the Apple development environment, and can be installed through the app store.
